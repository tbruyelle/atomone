...
// voters
func (keeper Keeper) TallyLegacy(ctx sdk.Context, proposal v1.Proposal) (passes bool, burnDeposits bool, tallyResults v1.TallyResult) {
...
func NewValidatorGovInfo(address sdk.ValAddress, bondedTokens math.Int, delegatorShares,
	delegatorDeductions sdk.Dec, options v1.WeightedVoteOptions,
) ValidatorGovInfo {
